...
public class ProjectController {
    ...
    public CreateProjectResponseDto createProject(HttpServletRequest request, @Valid @RequestBody CreateProjectRequestDto requestDto){
        ...
        return createProjectUsecase.createProject(jwtTokenProvider.getUserIdFromToken(token), requestDto.name(), requestDto.description(), requestDto.img(), requestDto.userEmails());
    }
